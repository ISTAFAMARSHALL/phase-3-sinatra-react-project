...
Game.create(name: "Final Fantasy XVI", genre_id: 2, platinum:"false")
Game.create(name: "Madden 2023", genre_id: 3, platinum: "false", score:3)
Game.create(name: "NBA 2K23 ", genre_id: 3, platinum: "false")
...
Game.create(name: "Street Fighter 6", genre_id: 5, platinum: "false")
Game.create(name: "Tekken 7", genre_id: 5, platinum: "True", score:5, completion_percentage: 100)
Game.create(name: "Tekken 8", genre_id: 5, platinum: "false")
